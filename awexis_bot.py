...
awexis_ai = aitextgen(
    model_folder=os.path.join("weedwexis", "model"),
    tokenizer_file=os.path.join("weedwexis", "model", "aitextgen.tokenizer.json"),
)
awexis = discord.Client(
    intents=intents,
...
class AwexisBot:
    ...
    async def message(self, message):
        ...
        elif self.client.user.mentioned_in(message) or message.content.startswith(
            "!wexis"
        ):
